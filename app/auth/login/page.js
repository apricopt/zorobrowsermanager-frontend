...
export default function LoginPage() {
  ...
  useEffect(() => {
    console.log('🔐 Login page - Auth state:', { 
      isAuthenticated, 
      isLoading, 
      user: isAuthenticated ? 'Present' : 'None' 
    });
  ...
  const handleGoogleLogin = () => {
    // Explicitly specify we're coming from web to ensure proper redirect
    window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001'}/auth/google?from=web`;
  };
      ...
      <div className="auth-card w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Sign in to your Zoro Browser Manager account
          </p>
        </div>
